...
| 2026-08-14 | v1.4 | 总表/明细表标题改名（经销商运营评估/经销商运营明细数据）、分销渠道占比列名「批发商→直销批发商」「分销商→直销分销商」 |
| 2026-09-14 | v1.5 | 总表移除「300万以上经销商占比」考核项（7→6 项指标、满分 100→90）；数据看板卡片标题改财年口径、删除返利明细/费用明细表 |
